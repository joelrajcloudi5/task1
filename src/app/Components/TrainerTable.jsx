            ...
            {trainers.length === 0 ? (
              ...
              trainers.map((trainer) => (
                <tr key={trainer._id} className="border-b">
                  ...
                  <td className="px-4 py-2">{trainer.designation}</td>
                  <td className="px-4 py-2">{trainer.course}</td>
                  <td className="px-4 py-2">{trainer.experience || "N/A"}</td>
                  <td className="px-4 py-2">{trainer.batchNumber || "N/A"}</td>
